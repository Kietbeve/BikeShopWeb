...
// Route cho admin
Route::get('/dangnhap',[AdminLoginController::class,'index']);
Route::post('/dangnhap',[AdminLoginController::class,'login']);

Route::middleware('CheckAdLoginStatus')->group(function(){
    Route::get('trangtrang',function()  {return view('admin.home.admin');});
    Route::get('bangdieukhien',[AdminLoginController::class, 'dashboard']);

						  ...
						  <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="{{asset("images/m1.jpg")}}" class="img-responsive" />
									<img class="etalage_source_image" src="{{asset("images/m1.jpg")}}" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{asset("images/m2.jpg")}}" class="img-responsive" />
								<img class="etalage_source_image" src="{{asset("images/m2.jpg")}}" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{asset("images/m3.jpg")}}" class="img-responsive"  />
								<img class="etalage_source_image" src="{{asset("images/m3.jpg")}}"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="{{asset("images/m4.jpg")}}" class="img-responsive"  />
								<img class="etalage_source_image" src="{{asset("images/m4.jpg")}}"class="img-responsive"  />
							</li>
						</ul>
						</div>
					 </div>
